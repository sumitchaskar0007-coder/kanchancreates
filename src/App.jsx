...
const services = [
  ['01', 'RVI Projects', 'Retail visual identity, signage and facade upgrades delivered to site standards.'],
  ['02', 'Integrated Projects', 'Civil, structural and branding execution brought together by one accountable team.'],
  ['03', 'Erection Work', 'Precise installation of canopies, signage and essential site infrastructure.'],
  ['04', 'Solar Site Projects', 'Solar panel installation and integration for efficient, modern fuel sites.'],
  ['05', 'Canopies, All Types', 'Fabrication and installation of canopy systems for fuel stations and industrial sites.'],
]
      ...
      <main>
        <section id="home" className="hero section-pad">
          ...
          <div className="hero-visual" aria-label="Fuel retail infrastructure visual">
            <img className="hero-photo" src={heroPhoto} alt="Sai fuel-retail infrastructure project" />
          </div>
        ...
        <section id="clients" className="clients section-pad"><div className="section-heading compact"><div><p className="eyebrow"><span /> Our clients</p><h2>Trusted by<br /><em>leading names.</em></h2></div><p className="section-intro">We support fuel-retail teams with dependable execution, clear coordination and infrastructure built to last.</p></div><div className="client-grid">{['HPCL', 'BPCL', 'OICL', 'IOCL', 'GO-BP', 'JIO-BP', 'NYRA', 'RELIANCE'].map((client) => <div className="client-logo" key={client}><span>{client}</span><small>Client</small></div>)}</div></section>
        ...
        <section id="about" className="about section-pad"><div className="about-aside"><p className="eyebrow"><span /> Who we are</p><img className="about-logo" src={saiLogo} alt="Sai Associates fuel-retail infrastructure" /></div><div className="about-copy"><h2>Infrastructure<br /><em>you can trust.</em></h2><p>Sai Associates is a fuel-retail infrastructure partner delivering RVI projects, integrated projects, fabrication, erection work, solar site projects and canopies of all types.</p><div className="about-columns"><div><small>Our approach</small><p>Coordinate every moving part clearly, from site identity and fabrication to installation and handover.</p></div><div><small>Our promise</small><p>Dependable execution, practical solutions and infrastructure built to perform for the long road ahead.</p></div></div></div></section>
